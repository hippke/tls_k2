...
def make_figure(KOI, planet_number, results, t, y, y_filt, trend, rawtime, rawflux, catalog, row, valid=False):
    ...
    if valid:  # 5-50d
        figure_out_path = 'GOOD50-1500d_' + str(KOI) + '_0' + str(planet_number)
    else:
        figure_out_path = '_FAIL50-1500d_' + str(KOI) + '_0' + str(planet_number)
...
def seach_one_koi(KOI):
    ...
    figure_out_path = 'FAIL50-1500d_' + str(KOI)
    figure_out_path2 = 'GOOD50-1500d_' + str(KOI)
